package ma.voiture.Controller;

import ma.voiture.Repository.VoitureRepository;
import ma.voiture.Services.ClientService;
import ma.voiture.Services.VoitureService;
...
public class VoitureController {
    ...
    public ResponseEntity<Object> findById(@PathVariable Long id) {
        try {
            ...
            // Appel Feign pour récupérer les infos complètes du client
    ...
    public ResponseEntity<Object> update(@PathVariable Long id, @RequestBody Voiture updatedVoiture) {
        try {
            ...
            // Mise à jour de la FK si fournie
            if (updatedVoiture.getClientId() != null) {
                existingVoiture.setClientId(updatedVoiture.getClientId());
            }
